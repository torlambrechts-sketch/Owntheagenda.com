-- =====================================================================
-- Carry the flow's assessment into the workshop it builds — Phase P (part 1).
-- When a flow auto-builds (or an admin manually builds) the workshop, the
-- survey that fed the gate is attached to a "Review the team reading" block so
-- the facilitator opens the session already looking at what the team said.
-- (Recreated in-repo to match the migration applied live in a prior session.)
-- =====================================================================
